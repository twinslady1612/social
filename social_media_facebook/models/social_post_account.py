...
class SocialPostAccount(models.Model):
    ...
    # Lead form relationship (for ads)
    ...
    lead_form_count = fields.Integer(
        ...
        help="Number of lead forms",
    )
    lead_count = fields.Integer(
        string="Leads",
        compute="_compute_lead_count",
        help="Total leads collected",
    )
    ...
    @api.depends("lead_form_ids.leads_count")
    def _compute_lead_count(self):
        """Count total leads from all forms"""
        for record in self:
            record.lead_count = sum(record.lead_form_ids.mapped("leads_count"))
