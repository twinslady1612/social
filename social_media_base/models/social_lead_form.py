...
class SocialLead(models.Model):
    ...
    def action_create_crm_lead(self):
        ...
        platform_name = self.platform.title() if self.platform else "Social Media"
        crm_values = {
            "name": self.name or f"{platform_name} Lead",
            "email_from": self.email,
            "phone": self.phone,
            "description": f"Source: {platform_name} Lead Form\nForm: {self.lead_form_id.name}",
        }
